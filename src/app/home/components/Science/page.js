                ...
                <div className="container mx-auto">
                    <div className="relative">
                        <div className="text-3xl breadcrumbs">
                            ...
                            <Link href="/category-list/sciences" className="">View All</Link>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="hero-content w-full sm:flex block">
                            ...
                            <div className="text-center md:w-6/12 p-6 rounded-xl">
                                <img
                                    ...
                                    src="https://sciencecouncil.org/web/wp-content/uploads/2020/10/thisisengineering-raeng-GjSYEBUZdDo-unsplash.jpg"
                                    alt="science"
                                    width={450}
                                    height={250}
                                />
                            ...
                            <div className="mx-auto p-6 md:w-6/12">
                                ...
                                <p className="py-6 text-lg">
                                    ...
                                    the natural and social world following a systematic methodology based on evidence.
                                </p>
                            </div>
                        </div>
                    </div>
